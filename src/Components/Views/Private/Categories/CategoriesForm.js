...
export default class CategoriesForm extends Component {
    ...
    componentDidMount() {
        RequestService.get(RequestUrl.categoryTypes, null, response => {
            this.setState({
                loading: false,
            ...
            (
                <div className="form clearfix-s">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            <CustomSelect label="Type" name="Type" options={this.state.options} value={this.props.formData.Type} onChange={this.handleInnerInputChange} error={errors.Type}/>
                        </div>
